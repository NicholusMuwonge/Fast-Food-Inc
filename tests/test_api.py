...
class test_api(unittest.TestCase):#defn of your own tests
    ...
    def setUpClass(self):  
        print('SetUp')
        blueprint = Blueprint('application.api.routes.mod', __name__)
        app.register_blueprint(blueprint) 
        self.orders = {"user_id": "U1", "item_ordered": "chicken and beef","item_quantity":"2kg"}      
        self.client = app.test_client() #a flask test_client() gives you  access tp get,post and put methods that help route to differnet URLs
